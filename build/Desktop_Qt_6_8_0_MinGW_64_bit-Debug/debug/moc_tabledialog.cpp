...
struct qt_meta_stringdata_CLASSTableDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTableDialogENDCLASS = QtMocHelpers::stringData(
    "TableDialog",
    "on_okButton_clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTableDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TableDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTableDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTableDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTableDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TableDialog, std::true_type>,
...
void *TableDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTableDialogENDCLASS.stringdata0))
