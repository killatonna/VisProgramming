...
public:
    ...
    void setupUi(QDialog *FindReplaceDialog)
    {
        ...
        replaceAllButton->setGeometry(QRect(330, 50, 101, 24));
        caseCheckBox = new QCheckBox(FindReplaceDialog);
        caseCheckBox->setObjectName("caseCheckBox");
        caseCheckBox->setGeometry(QRect(10, 20, 111, 22));
        layoutWidget = new QWidget(FindReplaceDialog);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(120, 20, 110, 56));
